...
exports.AuthWithTokenUser = exports.AuthWithTokenAdmin = exports.getUserById = exports.updateUser = exports.deleteUser = exports.getAllUser = exports.addUser = void 0;
...
function AuthWithTokenAdmin(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const username = request.body.username;
            const password = request.body.password;
            const res = yield (0, user_index_1.authTokenAdmin)(username, password);
            return response.status(200).json({ result: res });
        }
        catch (error) {
            return response
...
exports.AuthWithTokenAdmin = AuthWithTokenAdmin;
function AuthWithTokenUser(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const username = request.body.username;
            const password = request.body.password;
            const res = yield (0, user_index_1.authTokenClient)(username, password);
            console.log(typeof res);
            // if (typeof res) return response.status(200).json({ result: res });
        }
        catch (error) {
...
exports.AuthWithTokenUser = AuthWithTokenUser;
